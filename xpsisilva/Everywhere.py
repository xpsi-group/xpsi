...
from xpsisilva.cellmesh.global_mesh import construct_closed_cellMesh as _construct_closed_cellMesh
from xpsisilva.cellmesh.rays import compute_rays as _compute_rays

from xpsisilva.Parameter import Parameter
...
class Everywhere(ParameterSubspace):
    ...
    def time_invariant(self, invariant):
        ...
        if invariant: # can we safely assume azimuthal invariance?
            ...
            from xpsisilva.cellmesh.integrator_for_time_invariance import integrate as _integrator
    ...
    def rayXpanda_defl_lim(self):
        ...
        try:
            ...
            try:
                from xpsisilva.cellmesh import __rayXpanda_defl_lim__
            except ImportError:
                return None
            else:
