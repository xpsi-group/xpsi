...
represented by :class:`~xpsisilva.HotRegion.HotRegion` instances; however, the same
modules are used by an instance of the :class:`~xpsisilva.Everywhere.Everywhere` class.
The ``elsewhere_user.pyx`` extension module defines the customized radiation
field *exterior* to the :class:`~xpsisilva.HotRegion.HotRegion` instances on the surface.
...
def intensity_from_globals(double[::1] energies,
    ...
    :param double zeta:
        See the :class:`~xpsisilva.Spacetime` class property. Needed for
        effective gravity universal relation. It is recommended to supply this
        dimensionless variable by using an instance of :class:`~xpsisilva.Spacetime`.
...
def effective_gravity(double[::1] cos_colatitude,
    ...
    :param double[::1] zeta:
        ...
        properties. See :attr:`~xpsisilva.Spacetime.Spacetime.zeta`.

    :param double[::1] epsilon:
        A 1D :class:`numpy.ndarray` of a dimensionless function of stellar
        properties. See :attr:`~xpsisilva.Spacetime.Spacetime.epsilon`.
