...
from xpsisilva.cellmesh.mesh_tools import allocate_cells as _allocate_cells
from xpsisilva.cellmesh.mesh import construct_spot_cellMesh as _construct_spot_cellMesh
from xpsisilva.cellmesh.polar_mesh import construct_polar_cellMesh as _construct_polar_cellMesh
from xpsisilva.cellmesh.rays import compute_rays as _compute_rays
...
class HotRegion(ParameterSubspace):
    ...
    def symmetry(self, declaration):
        ...
        if declaration: # can we safely assume azimuthal invariance?
            if self._split:
                from xpsisilva.cellmesh.integrator_for_azimuthal_invariance_split import integrate as _integrator
                from xpsisilva.cellmesh.integratorIQU_for_azimuthal_invariance_split import integrate as _integratorIQU
            else:
                from xpsisilva.cellmesh.integrator_for_azimuthal_invariance import integrate as _integrator
                from xpsisilva.cellmesh.integratorIQU_for_azimuthal_invariance import integrate as _integratorIQU
        else: # more general purpose
            if self._split:
                raise TypeError("Split version of the integrator has not been implemented for symmetry=False.")
            from xpsisilva.cellmesh.integrator import integrate as _integrator
            from xpsisilva.cellmesh.integratorIQU import integrate as _integratorIQU
