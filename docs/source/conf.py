...
html_logo = "./_static/xpsilogo_small.png"
...
latex_documents = [
    (master_doc, 'xpsi.tex', 'X-PSI Documentation',
     'The X-PSI Core Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'xpsi', 'X-PSI Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'X-PSI', 'X-PSI Documentation',
