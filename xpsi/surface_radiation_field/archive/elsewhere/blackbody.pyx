...
cdef void* init_elsewhereRadField(size_t numThreads,
    ...
    # free_elsewhereRadField() in terms of freeing dynamically allocated memory.
...
cdef int free_elsewhereRadField(size_t numThreads, void *const data) nogil:
    ...
    # init_elsewhereRadField() in terms of freeing dynamically allocated memory.
    # This is entirely the user's responsibility to manage.
