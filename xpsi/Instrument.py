...
class Instrument(ParameterSubspace):
    ...
    def from_ogip_fits(cls,
        ...
        for key in ['min_channel', 'max_channel', 'min_input', 'max_input']:
            if key in kwargs.keys():
                print(f'WARNING: Deprecated keyword {key} has been provided. The whole instrument response matrix is now loaded. '
                      'This should not be an issue if the Data and/or Signal has proper min_channel and max_channel.')
