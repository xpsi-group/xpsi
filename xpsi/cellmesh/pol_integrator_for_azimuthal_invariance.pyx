                    ...
                    if mu > 0.0:
                        ...
                        for ks in range(2):
                            if (0 < k < leaf_lim - 1
                                ...
                                sin_chi_0 = - sin_theta_i*sin(leaves[k]) 
                                cos_chi_0 = sin_i*cos_theta_i - sin_theta_i*cos_i*cos(leaves[k])
                                ...
                                sin_chi_1 = sin_gamma*sin_i*sin(leaves[k])*sin_alpha/sin_psi #times sin alpha sin sigma
                                ...
                                cos_eps = (sin_alpha/sin_psi)*(cos_i*sin_lambda - sin_i*cos_lambda*cos(leaves[k]) + cos_psi*sin_gamma) - _cos_alpha*sin_gamma
