...
class Pulse(ParameterSubspace):
    ...
    :param obj interstellar:
        ...
        To be applied to the incident pulse signal as a callable that
    ...
    :param str['logspace','linspace'] default_energy_spacing:
        Should the energies for specific flux calculation be logarithmically
        or linearly spaced?

    :param float fast_rel_energies_per_interval:
        Fraction of the normal number of energies to use in *fast* mode.

    :param bool adaptive_energies:
        Only has effect if *fast* mode is activated for a hot region object.
        Attempts to redistribute energies for specific flux computation
        according to the shape information in the phase-averaged spectrum.
        The density of energy points will be higher towards the peak in
        the spectrum of a component of a hot region.

    :param float adapt_exponent:
        Choose a value on the unit interval. The *fast* mode estimate of the
        phase-averaged spectrum generated by a hot region (or the components
        thereof) is raised to this power when adapting the array of energies
        based on a *fast* mode spectrum estimate.
    ...
    :param bool cache:
        ...
        of the :class:`~.PostProcessing.PostProcessing` module. For likelihood
