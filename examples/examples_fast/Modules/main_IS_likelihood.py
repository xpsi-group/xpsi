########################################  Here we just changed the spin frequency from 314.0 Hz (which was used to generate the data) to 310.0 Hz   ###############################################
########################################  The new model is technically not correct. This is just an example                                                                                                        ###############################################
...
if __name__ == '__main__':
    ...
    from CustomPrior_IS import CustomPrior
    ...
    from Modules.CustomPrior_IS import CustomPrior
...
likelihood.check(None, [-3.1602509724e+04], 1.0e-5, physical_points=[p])
